...
Let us consider a random variable $X$ such that
\begin{align}
	X = \begin{cases}
		0 & \text{Tails}\\
		1 & \text{Heads}
...
\item{all heads}
\begin{align}
\pr{X=3} &= \frac{\text{All Heads}}{\text{Total number of outcomes}}\\
&= \frac{1}{8}
\end{align}
\item{atleast 2 heads}
\begin{align}
\pr{X\geq2} &= \frac{\text{atleast 2 heads}}{\text{Total number of outcomes}}\\
&= \frac{1}{2}
\end{align}
\end{enumerate}
\end{document}
