...
\begin{align}
H(f) \fourier{F}\{h(t)\} = \frac{1}{j2\pi f +1}
...
&= \frac{1}{2}\int_{-\infty}^{\infty} \frac{1}{(2\pi f)^2 +1} \, df\\
&= \frac{1}{2}\int_{-\infty}^{\infty} \frac{1}{(2\pi f)^2 +(1)^2} \, df\\
&= \frac{1}{2} \frac{1}{2\pi}tan^{-1}(x) |_{-\infty}^{\infty}\\
	&= \frac{1}{4\pi}(tan^{-1}(\infty)-tan^{-1}(-\infty))\\
	&= \frac{1}{4\pi}(\frac{\pi}{2}-\frac{-\pi}{2})\\
	&= \frac{1}{4\pi}(\pi) \\
&= \frac{1}{4}
\end{align}
