...
\end{align}
\begin{align}
(\vec{A}+k\vec{m}-\vec{I})^\tau(\vec{A}+k\vec{m}-\vec{I}) &= r^2
\end{align}
On simplifying the above equation:
\begin{align}
k^2\norm{\vec{m}}^2+2k(\vec{m})^\tau(\vec{A-I})+\norm{\vec{I}}^2 \nonumber \\
+\norm{\vec{A}}^2-2(\vec{A}^\tau\vec{I})-r^2 &= 0
\end{align}
\begin{enumerate}
...
D &= 0
\end{align}
Since the discriminant is $0$. The value of k will be $-b/2a$.
\begin{align}
