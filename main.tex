...
The parametric equation of line $\vec{A}\vec{B}$ is:
\begin{align}
&= \vec{A}+k(\vec{A-B})\\
&= \vec{A}+k\vec{m}
\end{align}
...
\end{align}
\begin{align}
(\vec{A}+k\vec{m}-\vec{I})^\tau \cdot (\vec{A}+k\vec{m}-\vec{I}) &= r^2
\end{align}
On simplifying the above equation:
\begin{align}
k^2\norm{\vec{m}}^2+2k(\vec{m})^\tau \cdot (\vec{A-I})+\norm{\vec{I}}^2 \nonumber \\
+\norm{\vec{A}}^2-2(\vec{A}^\tau \cdot \vec{I})-r^2 &= 0
\end{align}
The discriminant of the above quadratic equation is $0$. So solution of the equation is $-b/2a$.
\begin{align}
\therefore k &= -\frac{\vec{m}^\tau \cdot (\vec{A-I})}{2\norm{\vec{m}}^2}
\end{align}
Now the equation of $\vec{E}_3$ wil be
\begin{align}
\vec{E}_3 &=\vec{A}+k(\vec{m})
\end{align}
where $\vec{m} = \vec{A}-\vec{B}$ \\
Now putting the values of $\vec{A}, \vec{m}, \vec{I}$
\begin{align}
...
\end{align}
Similarily, we will find the point $\vec{F}_3$. For the point $\vec{F}_3$ the value of $\vec{m} = \vec{A}-\vec{C}$. 
\begin{align}
\vec{F}_3 &=\vec{A}+k(\vec{m})
\end{align}
Using equation $(8)$ we can find the value of $k$. 
\begin{align}
